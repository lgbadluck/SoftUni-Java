...
public class _08_NestedFolders {
        ...
        private static void printAllNestedDirectoriesWithBFS(File root) throws FileNotFoundException {
            PrintWriter writer = new PrintWriter(new OutputStreamWriter(
                    new FileOutputStream("src/StreamsFilesDirectoriesLabs/nested-directories-with-bfs.txt"))
            );
        ...
        private static void printAllNestedFilesWithDFS(File file) throws FileNotFoundException {
            PrintWriter writer = new PrintWriter(new OutputStreamWriter(
                    new FileOutputStream("src/StreamsFilesDirectoriesLabs/nested-folders-with-dfs.txt"))
            );
        ...
        private static void printAllNestedFilesWithBFS(File root) throws FileNotFoundException {
            PrintWriter writer = new PrintWriter(new OutputStreamWriter(
                    new FileOutputStream("src/StreamsFilesDirectoriesLabs/nested-folders-with-bfs.txt"))
            );
